...
@section('content')
    <div class="row align-items-start g-4">
                ...
                <div class="card-body p-4 p-xl-5">
                    <form id="generateBarcodeForm" class="vstack gap-3" novalidate>
                        ...
                        <div>
                            ...
                            <textarea id="barcodeData" class="form-control form-control-lg" rows="4" required
                                placeholder="Enter product name, SKU, description, or any text..."></textarea>
                            <div id="duplicateStatus" class="small mt-2"></div>
                        </div>

                        <div>
                            <label for="customLabel" class="form-label fw-semibold">Human Readable Label (shown below
                                barcode)</label>
                            <input type="text" id="customLabel" class="form-control form-control-lg"
        ...
        <div class="col-12 col-lg-7">
            <div id="previewCard"
                class="card border-2 border-dashed border-secondary-subtle bg-light-subtle shadow-sm rounded-4 h-100">
                <div class="card-body p-4 p-xl-5">
                    ...
                    <div id="previewSkeleton" class="placeholder-glow">
                        <div class="d-flex justify-content-center py-4">
                            <div class="placeholder bg-secondary-subtle rounded-3"
                                style="width: 100%; max-width: 440px; height: 220px;"></div>
                        </div>
                    ...
                    <div id="previewContent" class="d-none">
                        <div class="text-center">
                            <img id="barcodePreview" alt="Generated barcode preview"
                                class="img-fluid rounded-3 bg-white border p-3" style="max-width: 100%; display: none;">
                        </div>
                        ...
                        <div class="d-flex flex-wrap gap-2 justify-content-center mt-4">
                            ...
                            <button type="button" id="downloadSvg" class="btn btn-outline-dark d-none">Download
                                SVG</button>
                            <button type="button" id="printBarcode" class="btn btn-outline-primary d-none">Print
                                Barcode</button>
                            <a href="#" id="generateAnother" class="btn btn-link d-none text-decoration-none">Generate
                                another</a>
                        </div>
                    </div>
                </div>
    ...
    <script>
        (function() {
            ...
            async function checkDuplicate() {
                ...
                setDuplicateState(
                    'text-secondary',
                    '<span class="spinner-border spinner-border-sm me-2" aria-hidden="true"></span>Checking for duplicates...'
                );

                try {
                    const response = await fetch('/api/v1/barcodes/check-duplicate?data=' + encodeURIComponent(
                        value), {
                    ...
                    if (exists) {
                        setDuplicateState('is-warning',
                            '&#9888; Similar data exists, a new unique code will still be generated.');
                        return;
                    }
