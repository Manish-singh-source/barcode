            ...
            <div class='card-body'>
                <div class='d-flex align-items-start justify-content-between'>
                    <div>
                        ...
                        <div class='fs-2 fw-bold' id='totalProducts'>--</div>
                    </div>
...
<script>
    ...
    async function loadDashboardStats() {
        ...
        document.getElementById('totalProducts').textContent = payload.data.total_products;
    ...
    async function loadRecentBarcodes() {
        ...
        rows.forEach(function (item, index) {
            ...
            tr.innerHTML = 
                ...
                <td></td>
                <td></td>
                <td><a href=/barcodes/ class=btn btn-sm btn-outline-primary>View</a></td>
            ;
            body.appendChild(tr);
        });
