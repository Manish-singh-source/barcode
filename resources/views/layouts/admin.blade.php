...
<body class='admin-shell'>
    ...
    <aside id='adminSidebar' class='admin-sidebar d-flex flex-column p-3 p-lg-4'>
        ...
        <nav class='nav flex-column gap-2 flex-grow-1'>
            ...
            <a href='{{ url('/barcodes/generate') }}'
                class='nav-link sidebar-link {{ request()->is('barcodes/generate') ? 'active' : '' }}'>
                <i class='bi bi-plus-circle me-2'></i>Generate Barcode
            </a>
            <a href='{{ url('/barcodes') }}'
                class='nav-link sidebar-link {{ request()->is('barcodes') ? 'active' : '' }}'>
                <i class='bi bi-list-check me-2'></i>Barcodes List
            </a>
            <a href='{{ url('/scanner') }}'
                class='nav-link sidebar-link {{ request()->is('scanner') ? 'active' : '' }}'>
            ...
            <div class='d-flex justify-content-between align-items-center gap-3 px-3 px-lg-5 py-3'>
                <div class='d-flex align-items-center gap-3'>
                    <button type='button' id='sidebarToggleBtn'
                        class='btn btn-outline-secondary d-lg-none admin-menu-toggle' aria-label='Open navigation menu'
    ...
    <script src='https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js'
        integrity='sha384-YvpcrYf0tY3lHB60NNkmXc5s9fDVZLESaAA55NDzOxhy9GkcIdslK1N7N6jIeHz' crossorigin='anonymous'></script>
    <script>
        (function() {
